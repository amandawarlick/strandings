...
species.prop.HI <- pinnipeds.data %>%
  ...
  select(Pinniped.Common.Name, all.prop, prop.or, prop.wa, Prev.HI, Prop.Fisheries, Prop.Gunshot, Prop.Boat, Prop.Other) 

species.prop.HI[is.na(species.prop.HI)] <- 0

colnames(species.prop.HI) <- c("Species", "All Strandings (%)", "OR (%)", "WA (%)", "Prevalence of HI (%)", "Fisheries (%)", "Gunshot (%)", "Boat (%)", "Other (%)")
