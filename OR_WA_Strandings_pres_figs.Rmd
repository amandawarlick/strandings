...
presfigure_theme <- function(...) {
  theme(text = element_text(family = 'Times'),
    ...
    axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, color = "black", size = 13),
    axis.text.y = element_text(vjust = 0.5, color = "black", size = 13), 
...
ggsave(file = 'HI_type_facet_all.jpeg', HI_type_facet_all, device = 'jpeg', height = 8.5, width = 11, units = 'in', dpi = 600)
...
# ggsave(file = 'HIstrands_species1.jpeg', HIstrands_species, device = 'jpeg', height = 8.5, width = 11, units = 'in', dpi = 600)
...
aes(x = long_corr, y = lat_corr), col = 'black', bins = 2, size = .5) +  
  #scale_alpha(range = c(0, 0.1), guide = FALSE) +
  xlab("") + ylab("") +
...
ggsave(file = 'strands_species_seas1.jpeg', strands_species_seas1, device = 'jpeg', height = 8.5, width = 11, units = 'in', dpi = 1000)
...
ggsave(file = 'strands_species_seas_HI1.jpeg', strands_species_seas_HI1, device = 'jpeg', height = 8.5, width = 11, units = 'in', dpi = 1000)
...
gganimate(HIstrands_species_an_seas, interval = 4.0, filename = "~/Documents/R/Strandings/ENSO_Mapping/HIstrands_species_an_seas.gif") 
```
...
gganimate(all_strands_year_an, interval = 1.5, filename = "~/Documents/R/Strandings/ENSO_Mapping/all_strands_year_an.gif")
...
gganimate(all_strands_year_an_sp, interval = 1.5, filename = "~/Documents/R/Strandings/ENSO_Mapping/all_strands_year_an_sp.gif")
