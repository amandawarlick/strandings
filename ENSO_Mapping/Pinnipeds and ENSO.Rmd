...
```{r load pre-cleaned data, echo = FALSE}
...
#Fish
Anch_CPUE <- read.csv("Anch_CPUE.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Anchovy_South <- read.csv("Anchovy_South.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
CBA_North <- read.csv("CBA_North.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
CBA_South <- read.csv("CBA_South.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Chin_growth <- read.csv("Chin_growth.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Chinook_escape <- read.csv("Chinook_escape.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
CPS_lands <- read.csv("CPS_lands.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Herring_CPUE <- read.csv("Herring_CPUE.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Salmon_lands <- read.csv("Salmon_lands.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Sardine_CPUE <- read.csv("Sardine_CPUE.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Sardine_South <- read.csv("Sardine_South.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Tot_lands <- read.csv("Tot_lands.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
...
#Ocean
MEI <- read.csv("MEI.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
NPGO <- read.csv("NPGO.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
PDO <- read.csv("PDO.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
SST_39 <- read.csv("SST_39.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
SST_44 <- read.csv("SST_44.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Upwell_39 <- read.csv("Upwell_39.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Upwell_45 <- read.csv("Upwell_45.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Wind_39 <- read.csv("Wind_39.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
Wind_44 <- read.csv("Wind_44.csv", header = TRUE, na.strings = "", stringsAsFactors = FALSE) 
...
ENSO.all.figure <- 
  ggplot(ENSO.all, aes(x = ENSO_cat, y = cnt, fill = ENSO_cat)) +
  geom_boxplot() +
...
kruskal.test(ENSO.all)
kruskalmc(cnt ~ ENSO, ENSO.all)

ENSO_yr <- pinnipeds_small %>%
  filter(Observation.Status == 'ALIVE' | Observation.Status == 'FRESH DEAD') %>%
  group_by(Pinniped.Common.Name, ENSO, Year.of.Observation, Month.of.Observation) %>%
  summarize(cnt = n_distinct(National.Database.Number))

ENSO_sp_figure <- ggplot(data = ENSO_yr, aes(x = Pinniped.Common.Name, y = cnt, group = ENSO, fill = ENSO)) +
  geom_boxplot(group = 'ENSO')

ENSO_model <- glm(cnt ~ ENSO + Pinniped.Common.Name, family = poisson(link = log), data = ENSO_yr)
summary(ENSO_model)
posthoc.kruskal.nemenyi.test()
kruskalmc(ENSO_model$cnt ~ ENSO_model$ENSO)
summary(aov(cnt ~ Pinniped.Common.Name*ENSO, data = ENSO_yr))

MEI_yr <- pinnipeds_small %>%
  filter(Observation.Status == 'ALIVE' | Observation.Status == 'FRESH DEAD') %>%
  group_by(Pinniped.Common.Name, ENSO, MEI, Year.of.Observation, Month.of.Observation) %>%
  summarize(cnt = n_distinct(National.Database.Number))

MEI_model <- lm(cnt ~ MEI*Pinniped.Common.Name + Year.of.Observation + Month.of.Observation, data = MEI_yr)
summary <- summary(MEI_model)
autoplot(MEI_model)
