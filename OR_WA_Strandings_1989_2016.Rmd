...
colnames(Sex_HI_type_table) <- c("Class", "All Strandings (%)", "HI Proportion (%)", "Fisheries Interactions (%)", "Gunshots (%)", "Boat Injuries (%)", "Other (%)")
...
colnames(Age_HI_type_table) <- c("Class", "All Strandings (%)", "HI Proportion (%)", "Fisheries Interactions (%)", "Gunshots (%)", "Boat Injuries (%)", "Other (%)")
