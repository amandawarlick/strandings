...
sex_region <- pinnipeds_data %>%
  ...
  select(Sex, OR_Coast_p, WA_Coast_p, Inland_WA_p)
...
Sex_HI_type_table <- pinnipeds_data %>%
  ...
  select(c(Sex, all.cnt, All.prop, OR_Coast_p, WA_Coast_p, Inland_WA_p, Prev.HI, Prop.fish, Prop.shot, Prop.boat, Prop.other))
colnames(Sex_HI_type_table) <- c("Class", "Total (n)", "All Strandings (%)", "OR Coast (%)", "WA Coast (%)", "WA Inland (%)", "HI Proportion (%)", "Fisheries Interactions (%)", "Gunshots (%)", "Boat Injuries (%)", "Other (%)")
...
age_region <- pinnipeds_data %>%
  ...
  transform(OR_Coast_p = round(OR_Coast/(Inland_WA+OR_Coast+WA_Coast)*100, 1),
            WA_Coast_p = round(WA_Coast/(Inland_WA+OR_Coast+WA_Coast)*100, 1),
            Inland_WA_p = round(Inland_WA/(Inland_WA+OR_Coast+WA_Coast)*100, 1)) %>%
  select(Age.Class, OR_Coast_p, WA_Coast_p, Inland_WA_p)
...
Age_HI_type_table <- pinnipeds_data %>%
  ...
  select(c(Age.Class, all.cnt, All.prop, OR_Coast_p, WA_Coast_p, Inland_WA_p, Prev.HI, Prop.fish, Prop.shot, Prop.boat, Prop.other))
Age_HI_type_table <- Age_HI_type_table[order(Age_HI_type_table$Age),]
colnames(Age_HI_type_table) <- c("Class", "Total (n)", "All Strandings (%)", "OR Coast (%)", "WA Coast (%)", "WA Inland (%)", "HI Proportion (%)", "Fisheries Interactions (%)", "Gunshots (%)", "Boat Injuries (%)", "Other (%)")
