...
Amanda J. Warlick,^1^ Stephanie A. Norman,^2^ Lesanna L. Lahner,^3^ Jessica L. Huggins,^4^ James M. Rice,^5^ Erin D'agnese,^6^ Jennifer Oleson,^7^ Joseph K. Gaydos,^8^ Victoria Souze,^9^ Alysha Elsby,^9^ Deborah A. Duffield,^10^ Dyanna M. Lambourn^11^, and John Calambokidis^4^
...
<!-- `r figs("statelineplot", caption = "Annual strandings over the study period and standard error bands show greater volume and increasing number of strandings in Oregon (y = 1.052^x^, z = 3.78, *p* < 0.001) and inland Washington waters (y = 1.040^x^, z = 4.95, *p* < 0.001) compared with the outer Washington coast (y = 1.074^x^, z = 3.62, *p* < 0.001).")` -->
