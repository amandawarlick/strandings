...
# Realized I shouldn't be putting all six species in the same model, so went on to do them separately below.
...
#Separate species models, is there a better way to do this if I'm really just asking the simple question of changes over time rather than a more complex best-fit model with more explanatory variables?
...
# Again, had species combined, then separated them out below.
