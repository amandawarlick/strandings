...
#regression equation: y = exp(0.07377*x) = 1.10^x = 10% per year
...
summary(glm.nb(cnt ~ Year.of.Observation, data = HI_type_by_year %>% filter(Interaction.Type == 'Fisheries')))  #exp(0.06605) = y = 1.068
...
#per period
summary(glm(cbind(Yes, No) ~ period, family = binomial, data = HI_yes_no_sp_period %>% filter(Pinniped.Common.Name == 'Harbor seal'))) #higher late: p < 0.001, z = 6.6, y = 0.6x
